...
| NILLION_NILCHAIN_REST_API          | https://testnet-nillion-api.lavenderfive.com                                                        |

### Python .env Testnet Configuration
...
NILLION_NILCHAIN_CHAIN_ID=nillion-chain-testnet-1
NILLION_NILCHAIN_GRPC=65.109.228.73:9090
NILLION_NILCHAIN_PRIVATE_KEY_0=YOUR_TESTNET_FUNDED_PRIVATE_KEY
```

React .env Testnet Configuration
```
